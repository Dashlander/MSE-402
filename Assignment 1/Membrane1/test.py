...
def plot_atom_counts(counts):
    ...
    plt.title("Number of Methane Molecules Diffused through Membrane 1")
    plt.xlabel("Time")
...
# Example usage
file_path = "/home/dashlander/Desktop/Sem7/CPD/Assignment 1/Membrane1/dump.lammpstrj"  # Replace with your dump file path
