...
def plot_atom_counts(counts):
    ...
    plt.plot(timesteps, atom_counts, linestyle='-', color='r')
    plt.title("Number of Methane Molecules Diffused through Membrane 2")
    plt.xlabel("Time")
    plt.ylabel("Number of Molecules")
    plt.xlim(-100,1005000)
    # plt.ylim(-0.1,2.1)
    plt.grid(False)
    plt.show()

# Example usage
file_path = "/home/dashlander/Desktop/Sem7/CPD/Assignment 1/Membrane2/dump.lammpstrj"  # Replace with your dump file path
