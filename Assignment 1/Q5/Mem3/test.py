...
def plot_atom_counts(counts):
    ...
    plt.plot(timesteps, atom_counts, linestyle='-', color='g')
    plt.title("Number of Water Molecules Diffused through Membrane 3")
    plt.xlabel("Time")
...
# Example usage
file_path = "/home/dashlander/Desktop/Sem7/CPD/Assignment 1/Q5/Mem3/dump.lammpstrj"  # Replace with your dump file path
