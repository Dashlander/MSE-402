...
def plot_atom_counts(counts):
    ...
    plt.title("Number of Carbon DiOxide Molecules Diffused through Membrane 2")
    plt.xlabel("Time")
...
# Example usage
file_path = "/home/dashlander/Desktop/Sem7/CPD/Assignment 1/Q5/Mem2/dump.lammpstrj"  # Replace with your dump file path
